...
CREATE TABLE aviones (
  ...
  id_modelo INTEGER REFERENCES modelos_avion(id_modelo),
...
CREATE TABLE vuelos (
  ...
  id_aeropuerto_origen INTEGER REFERENCES aeropuertos(id_aeropuerto),
  id_aeropuerto_destino INTEGER REFERENCES aeropuertos(id_aeropuerto),
...
INSERT INTO aeropuertos (id_aeropuerto, nombre, ciudad, codigo_iata) VALUES
...
INSERT INTO modelos_avion (id_modelo, fabricante, nombre_modelo, capacidad_pasajeros) VALUES
...
INSERT INTO pasajeros (id_pasajero, nombre_completo, pasaporte, nacionalidad) VALUES
...
INSERT INTO pilotos (id_piloto, nombre_completo, licencia, horas_vuelo) VALUES
(1, 'Javier Mendoza', 'EASA-102938', 4500),
(2, 'Robert Harrison', 'FAA-992011', 8200),
(3, 'Luisa Fernández', 'EASA-33', 5200);

INSERT INTO aviones (id_avion, matricula, id_modelo, estado) VALUES
(1, 'EC-NPR', 1, 'activo'),
(2, 'N834AA', 2, 'activo'),
(3, 'N888XX', 3, 'activo'),
(4, 'EC-LXY', 1, 'activo'),
...
INSERT INTO vuelos (id_vuelo, numero_vuelo, id_avion, id_aeropuerto_origen, id_aeropuerto_destino, id_piloto) VALUES
(1, 'IB0123', 1, 1, 2, 1),
(2, 'BA0116', 2, 3, 4, 2),
(3, 'IB0124', 1, 1, 3, 1),
(4, 'BA0117', 3, 3, 1, 3),
...
INSERT INTO reservas (id_reserva, id_vuelo, id_pasajero, asiento, clase, precio_billete) VALUES
